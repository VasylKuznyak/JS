/*За допомогою циклу вивести всю інформацію про користувачів використовуючи шаблон Template 1.1
			* за допомоги стилів, побудувати сітку по 2 обєкта в лінію
			*
			* */
// <!--template 1.1-->
// <div class="users-box">
...
//         document.write(`<h2>ID - ${usersListElement.id} - NAME - ${usersListElement.name} - USERNAME - ${usersListElement.username}</h2>`);
//         document.write(`<h3>EMAIL - ${usersListElement.email} - PHONE - ${usersListElement.phone}</h3>`);
//     document.write(`</div>`);
