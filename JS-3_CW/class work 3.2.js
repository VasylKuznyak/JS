...
//     document.write(`<h1>${simpson.name} ${simpson.surname} - ${simpson.age} years old</h1>`);
//     document.write(`<p>${simpson.info}</p>`);
//     document.write(`<div><img src="${simpson.photo}" alt="simpson"></div>`);
//     document.write(`</div>`);
// }
...
//             document.write(`<h3 class="product-title">${product.title}. Price - ${product.price}`);
//             document.write(`<img src="${product.image}" alt="${product.title} image" class="product-image">`);
//         document.write(`</div>`);
// }
// document.write(`</div>`);
