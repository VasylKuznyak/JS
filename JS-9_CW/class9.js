...
for (let simpson of simpsons) {
    ...
    for (let key in simpson) {
        if (key !== 'photo') {
            let inDiv = document.createElement('div');
            inDiv.innerText = `${key}: ${simpson[key]}`;
